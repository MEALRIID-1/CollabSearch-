...
/**
 * Requête de création de publication - CollabSearch
 */
class StorePublicationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'type' => ['required', 'string', 'in:article,conference,these,rapport,livre'],
    ...
    {
        return [
            'title.required' => 'Le titre de la publication est obligatoire.',
            'type.required' => 'Le type de publication est obligatoire.',
